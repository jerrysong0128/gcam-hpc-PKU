...
module load gcc                 # Matches your $CXX=g++
module load boost     # Matches your BOOST paths
module load java                 # Matches your JAVA paths

# 3. Load Intel/OneAPI components that match your TBB version
module load tbb               # Matches your TBB paths
module load mpi               # OneAPI MPI (matches TBB 2021.9.0)
module load intel
moudle load intel_ippcp_intel64

# 4. Load additional tools
module load cmake              # Conservative version
