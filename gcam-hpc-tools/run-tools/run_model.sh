...
# 1. First unload any conflicting modules
module purge

# 2. Load compiler and core dependencies
module load gcc/12.2.0                 # Matches your $CXX=g++
module load boost/1.65.1-gcc-4.8.5     # Matches your BOOST paths
module load java/1.8.0                 # Matches your JAVA paths

# 3. Load Intel/OneAPI components that match your TBB version
module load tbb/2021.9.0               # Matches your TBB paths
module load mpi/2021.9.0               # OneAPI MPI (matches TBB 2021.9.0)
module load intel/2019.1
moudle load intel_ippcp_intel64/2021.3.0

# 4. Load additional tools
module load cmake/3.16.0               # Conservative version
