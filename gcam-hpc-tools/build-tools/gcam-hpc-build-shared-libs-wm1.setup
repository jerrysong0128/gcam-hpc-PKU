...
# syntax avoids the invalid redirection-like "<absolute path ...>" assignment.
if [ -z "${GCAM_HPC_PKU_HOME:-}" ]; then
    echo "NOTICE: Set GCAM_HPC_PKU_HOME to the absolute path of gcam-hpc-PKU."
    echo "Example: export GCAM_HPC_PKU_HOME=/path/to/gcam-hpc-PKU"
